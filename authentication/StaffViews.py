...
from authentication.models import Attendance, AttendanceReport, Courses, CustomUser, FeedBackStaffs, LeaveReportStaff, SessionYearModel, Staffs, Students, Subjects


def staff_home(request):
    #for fetching all students under current staff
...
def save_attendance_data(request):
    ...
    try:
        ...
        for stud in json_sstudent:
            ...
            attendace_report=AttendanceReport(student_id=student,attendance_id=attendance,status=stud['status'])

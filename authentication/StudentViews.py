...
from authentication.models import Attendance, AttendanceReport, Courses, CustomUser, FeedBackStudent, LeaveReportStudent, Students, Subjects
...
def student_home(request):   
    ...
    return render(request,"student_template/student_home_template.html",{"total_attendance":attendance_total,"attendance_absent":attendance_absent,"attendance_present":attendance_present,"subjects":subjects,"subject_name":subject_name,"data_present":data_present,"data_absent":data_absent})
